...
/*
 * @dev This tests the Alkemi Earn Verified with tests for calculateInterestIndex.
 */
contract AlkemiEarnVerifiedTest_CalculateInterestIndex is
    AlkemiEarnVerifiedTest
{
    function testCalculateInterestIndex_SimpleCalculation() public {
        ...
        Assert.equal(
            ...
            "should have correct rate of 5%, which is 5e16e-18"
        );

        uint256 blockStart = 100;
        uint256 blockEnd = 110;
    ...
    function testCalculateInterestIndex_MoreComplicatedCalculation() public {
        uint256 startingInterestIndex = 111111111111111111;
        ...
        Assert.equal(
            scientific(5, 11),
            interestRate.mantissa,
            "should have correct rate of 0.00005%, which is 5e11e-18"
        );
    ...
    function testCalculateInterestIndex_AnotherComplicatedCalculation() public {
        uint256 startingInterestIndex = 222222222222222222;
        ...
        Assert.equal(
            scientific(1, 16),
            interestRate.mantissa,
            "should have correct rate of 1%, which is 1e16e-18"
        );

        uint256 blockStart = 1;
        uint256 blockEnd = 10000; // 9999 blocks

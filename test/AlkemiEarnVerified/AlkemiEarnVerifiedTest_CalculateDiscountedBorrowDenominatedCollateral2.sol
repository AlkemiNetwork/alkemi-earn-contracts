 ...
 */
contract AlkemiEarnVerifiedTest_CalculateDiscountedBorrowDenominatedCollateral2 is
    AlkemiEarnVerifiedWithPriceTest
{
    function testCalculateDiscountedBorrowDenominatedCollateral_HugeSupplyCurrentCausesOverflow()
        public
    {
        ...
        assertError(
            ...
            err,
            "should overflow from a huge supplyCurrent"
        );
    }

    function testCalculateDiscountedBorrowDenominatedCollateral_HugePriceUnderwaterAssetCausesOverflow()
        public
    {
        ...
        assertError(
            Error.INTEGER_OVERFLOW,
            err,
            "should overflow from a huge assetPrice of underwater asset"
        );
    }

    function testCalculateDiscountedBorrowDenominatedCollateral_ZeroPriceCollateralCausesDivisionByZero()
        public
    {
        Exp memory collateralPrice = Exp({mantissa: mantissaOne * 3});
        ...
        assertError(
            ...
            err,
            "should get division by zero when borrowed asset has price of zero"
        );
    }
}

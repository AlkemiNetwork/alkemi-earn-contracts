...
contract AlkemiEarnVerifiedLightHarness is AlkemiEarnVerified {
     ...
     *      Note: If useOracle is true, then we don't use this mapping and instead call the real function of AlkemiEarnVerified.

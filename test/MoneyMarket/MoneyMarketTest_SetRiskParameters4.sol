...
contract MoneyMarketTest_SetRiskParameters4 is MoneyMarketTest {
    ...
    function testSetRiskParameters_LiquidationDiscountOverMaxValueFails() public {
        ...
        assertError(Error.INVALID_LIQUIDATION_DISCOUNT, Error(_setRiskParameters(newRatio.mantissa, newDiscount.mantissa, oldRatio.mantissa, oldDiscount.mantissa)), "operation not should have succeeded");
    ...
    function testSetRiskParameters_LiquidationDiscountPlusOneEqualsCollateralRatioFails() public {
        ...
        assertError(Error.INVALID_COMBINED_RISK_PARAMETERS, Error(_setRiskParameters(newRatio.mantissa, newDiscount.mantissa, oldRatio.mantissa, oldDiscount.mantissa)), "operation not should have succeeded");

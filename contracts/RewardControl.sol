...
contract RewardControl {
    ...
    /** updateCompBorrowIndex usage
     * borrowAllowed --> borrow
     * repayBorrowAllowed --> repayBorrow
     * refreshCompSpeedsInternal (used by refreshCompSpeeds)
     * claimComp --> claimAlk
     */
    function refreshAlkIndexForBorrower(address market, address borrower) public {
        refreshAlkSpeeds();
     ...
     * @param Exp memory marketBorrowIndex ???
     */
     ...
     */
    function distributeBorrowerAlk(address market, address borrower, Exp memory marketBorrowIndex) internal {}

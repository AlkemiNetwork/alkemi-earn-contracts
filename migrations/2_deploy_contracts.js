...
module.exports = async (deployer, network, accounts) => {
    if (
        ...
        await moneyMarket.addCustomerKYC(accounts[0]);

        const rewardControl = await deployProxy(RewardControl, [accounts[0], moneyMarket.address, deploymentConfig.RINKEBY.ALK_TOKEN], {
            deployer,
            initializer: "initializer",
            unsafeAllowCustomTypes: true,
        });

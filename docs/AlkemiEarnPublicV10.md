---
layout: default
title: AlkemiEarnPublicV10
---

# AlkemiEarnPublicV10.sol

View Source: [contracts/AlkemiEarnPublicV10.sol](../contracts/AlkemiEarnPublicV10.sol)
...
mapping(address => mapping(address => struct AlkemiEarnPublicV10.Balance)) public supplyBalances;
mapping(address => mapping(address => struct AlkemiEarnPublicV10.Balance)) public borrowBalances;
address public wethAddress;
contract AlkemiWETH public WETHContract;
mapping(address => struct AlkemiEarnPublicV10.Market) public markets;
...
- [emitLiquidationEvent(struct AlkemiEarnPublicV10.LiquidateLocalVars localResults)](#emitliquidationevent)
...
```js
function emitLiquidationEvent(struct AlkemiEarnPublicV10.LiquidateLocalVars localResults) internal nonpayable
```
...
| Name        | Type           | Description  |
| ------------- |------------- | -----|
| localResults | struct AlkemiEarnPublicV10.LiquidateLocalVars |  | 
